...
namespace WaterMarkAppUI.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ProductController(AppDbContext context, RabbitMQProducer rabbitMQProducer)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Stock")] Product product, IFormFile ImageFile)
        {
            ...
            if (ImageFile is { Length:>0})
            {
                ...
                _rabbitMQProducer.Publish(new() { ImageName = randomImageName });
